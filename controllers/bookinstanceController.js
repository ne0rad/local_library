...
exports.bookinstance_delete_post = function (req, res, next) {
    ...
    BookInstance.findByIdAndRemove(req.body.bookinstanceid, function deleteBookInstance(err) {
        if (err) { return next(err); }
        // Success, so redirect to book list
...
exports.bookinstance_update_get = function (req, res, next) {
    async.parallel({
        ...
        // Success.
        res.render('bookinstance_form', { title: 'Update BookInstance', book_list: [results.bookinstance.book], bookinstance: results.bookinstance });
    })
};
...
exports.bookinstance_update_post = function (req, res, next) {
        ...
        body('book', 'Book must be specified').notEmpty();
        body('imprint', 'Imprint must be specified').notEmpty();
        body('status', 'Status must be specified').notEmpty();
